...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldDisplayPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldDisplayPlatform:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field display_platform", values[i])
			} else if value.Valid {
				_m.DisplayPlatform = new(string)
				*_m.DisplayPlatform = value.String
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.DisplayPlatform; v != nil {
		builder.WriteString("display_platform=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
