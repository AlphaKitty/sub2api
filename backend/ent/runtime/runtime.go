...
func init() {
	...
	checkinrecordDescStreakDays := checkinrecordFields[2].Descriptor()
	...
	checkinrecordDescRewardAmount := checkinrecordFields[3].Descriptor()
	...
	// groupDescDisplayPlatform is the schema descriptor for display_platform field.
	groupDescDisplayPlatform := groupFields[11].Descriptor()
	// group.DisplayPlatformValidator is a validator for the "display_platform" field. It is called by the builders before save.
	group.DisplayPlatformValidator = groupDescDisplayPlatform.Validators[0].(func(string) error)
