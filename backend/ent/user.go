...
type UserEdges struct {
	...
	// CheckInRecords holds the value of the check_in_records edge.
...
func (e UserEdges) CheckInRecordsOrErr() ([]*CheckInRecord, error) {
	...
	return nil, &NotLoadedError{edge: "check_in_records"}
}
...
// QueryCheckInRecords queries the "check_in_records" edge of the User entity.
