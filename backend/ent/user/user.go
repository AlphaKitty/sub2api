...
const (
	...
	// EdgeCheckInRecords holds the string denoting the check_in_records edge name in mutations.
	EdgeCheckInRecords = "check_in_records"
	...
	// CheckInRecordsTable is the table that holds the check_in_records relation/edge.
	CheckInRecordsTable = "check_in_records"
	...
	CheckInRecordsInverseTable = "check_in_records"
	// CheckInRecordsColumn is the table column denoting the check_in_records relation/edge.
...
// ByCheckInRecordsCount orders the results by check_in_records count.
...
// ByCheckInRecords orders the results by check_in_records terms.
