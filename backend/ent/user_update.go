...
// AddCheckInRecords adds the "check_in_records" edges to the CheckInRecord entity.
...
// ClearCheckInRecords clears all "check_in_records" edges to the CheckInRecord entity.
func (_u *UserUpdate) ClearCheckInRecords() *UserUpdate {
	_u.mutation.ClearCheckInRecords()
	return _u
}

// RemoveCheckInRecordIDs removes the "check_in_records" edge to CheckInRecord entities by IDs.
func (_u *UserUpdate) RemoveCheckInRecordIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveCheckInRecordIDs(ids...)
	return _u
}

// RemoveCheckInRecords removes "check_in_records" edges to CheckInRecord entities.
