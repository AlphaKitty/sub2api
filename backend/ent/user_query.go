...
// QueryCheckInRecords chains the current query on the "check_in_records" edge.
...
// the "check_in_records" edge. The optional arguments are used to configure the query builder of the edge.
