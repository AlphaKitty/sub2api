...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/model-mapping-templates", h.Admin.Account.GetModelMappingTemplates)
		accounts.PUT("/model-mapping-templates", h.Admin.Account.SaveModelMappingTemplates)
		accounts.POST("/apply-model-mapping-template", h.Admin.Account.ApplyModelMappingTemplate)
