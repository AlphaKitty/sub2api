...
func ProvideAdminHandlers(
	...
	scheduledTestHandler *admin.ScheduledTestHandler,
		accountHealthPolicyHandler *admin.AccountHealthPolicyHandler,
	...
	return &AdminHandlers{
		...
		AccountHealthPolicy:    accountHealthPolicyHandler,
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		...
		errorPassthroughService, contentModerationService, userMsgQueueService, cfg, settingService, pricingService)
...
var ProviderSet = wire.NewSet(
	...
	admin.NewAccountHealthPolicyHandler,
