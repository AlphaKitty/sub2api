export default {
    settings: {
      ...
      defaults: {
        ...
        checkInTitle: '每日签到奖励',
        checkInDescription: '用户每日签到可领取小额余额奖励，7 天一个周期循环发放',
        checkInDay: '第{n}天',
        checkInRewardsHint: '第 7 天为大奖日；断签后从第 1 天重新开始。奖励直接入账用户余额（USD）',
        checkInMinRegAge: '注册冷却（小时）',
        checkInMinRegAgeHint: '注册满 N 小时才能签到，防注册机刷奖励；0 = 不限制',
        checkInMaxMonthly: '月累计封顶 (USD)',
        checkInMaxMonthlyHint: '每月签到奖励累计上限，超出后当月无法再签到；0 = 不限制',
