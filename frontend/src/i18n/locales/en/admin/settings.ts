export default {
    settings: {
      ...
      defaults: {
        ...
        checkInTitle: 'Daily Check-in Rewards',
        checkInDescription: 'Users earn a small balance reward by checking in daily, cycling every 7 days',
        checkInDay: 'Day {n}',
        checkInRewardsHint: 'Day 7 is the bonus day; a missed day resets the cycle. Rewards are credited to the user balance (USD)',
        checkInMinRegAge: 'Signup Cooldown (hours)',
        checkInMinRegAgeHint: 'Users can check in only N hours after signup, to deter bots; 0 = no restriction',
        checkInMaxMonthly: 'Monthly Cap (USD)',
        checkInMaxMonthlyHint: 'Cumulative monthly check-in reward cap; 0 = unlimited',
