export default {
    ...
    groups: {
      ...
      form: {
        ...
        platform: 'Platform',
        displayPlatform: 'Display platform (optional)',
        displayPlatformPlaceholder: 'No override (show real platform)',
        rateMultiplier: 'Rate Multiplier',
        status: 'Status',
      ...
      displayPlatformTooltip: 'User-facing icon/badge renders as the display platform; routing and billing still use the real platform',
      displaysAs: 'Displays as {platform}',
      displayPlatformHint: 'Only affects the brand shown to users (icon/badge); routing, billing and account pool are unchanged',
      saving: 'Saving...',
      ...
      healthPolicyThreshold: 'Consecutive failure threshold',
      healthPolicyOnFailure: 'On failure',
      healthPolicyActionDisable: 'Disable scheduling (schedulable=false)',
      healthPolicyActionNone: 'Record only',
      healthPolicyRecover: 'Recover rate-limit / temp state on success',
      healthPolicyReenable: 'Re-enable disabled accounts on success',
      healthPolicyRunNow: 'Run now',
      healthPolicyRunning: 'Running…',
      healthPolicyDelete: 'Delete policy',
      healthPolicyHistory: 'Recent runs',
      healthPolicyNoRuns: 'No runs yet',
      healthPolicyViewItems: 'View items',
      healthPolicyNoItems: 'No account items',
      healthPolicyAccount: 'Account',
      healthPolicyAction: 'Action',
      healthPolicyRunSummary: 'Total {total} · OK {ok} · Failed {fail} · Actions {action}',
      healthPolicyModelRequired: 'Test model is required',
      healthPolicyLoadFailed: 'Failed to load health policy',
      healthPolicySaved: 'Health policy saved',
      healthPolicySaveFailed: 'Failed to save health policy',
      healthPolicyRunDone: 'Health check finished',
      healthPolicyRunFailed: 'Failed to run health check',
      healthPolicyDeleted: 'Health policy deleted',
      healthPolicyDeleteFailed: 'Failed to delete health policy',
